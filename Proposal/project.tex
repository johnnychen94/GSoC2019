...
While doing the documentation and code refactoring work, this project will have many side effects:
\begin{itemize}
...
\end{itemize}
Note that these side effects are not included as a part of this project.
