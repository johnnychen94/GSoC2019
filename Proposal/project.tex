...
Basically, this is a project on documentation and code refactoring to privide more consistent, robust and extensive APIs to both users and developers, and this is also a sub-project to \images{} \sname{v1.0} milestone. Potentially involved packages are:
\begin{itemize}
...
\end{itemize}
Hence the purpose of this project isn't to make the ecosystem perfect, instead, it is to evolve an ecosystem that is significantly better in API and naming style with comprehensive documentation, so that future development towards \images{} \version{1.0} is possible.
