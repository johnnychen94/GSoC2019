...
\begin{itemize}
    \item Patch: \pullrequest{\julialang}{julia}{29626}\footnote{I only learned \langjulia{} for two months at that moment}  {\small -- reviewed by \mbauman}\\
      {\small
    ...
    \item Patch: \pullrequest{\fluxml}{\flux}{710} {\small -- reviewed by \mikeinnes}\\
      {\small
