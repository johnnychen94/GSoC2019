...
I started to use \langmatlab to research image processing at the end of 2016, met  \langjulia after its \version{1.0} announcement, and learned \langpython during the Spring Festival of 2019. \par
...
\begin{itemize}
    ...
    \item PR: \pullrequest{\juliaimages}{\imagedistance}{8} reviewed by \julio;
    \item PR: \pullrequest{\juliaimages}{\imagesgithubio}{50} reviewed by \evizero;
    \item PR: \pullrequest{\juliaimages}{\testimages}{35} reviewed by \timholy;
    \item PR(Pending): \pullrequest{zygmuntszpak}{\imagebinarization}{25} reviewed by \zygmunt;
    \item PR(Pending): \pullrequest{\fluxml}{\flux}{710} reviewed by \mikeinnes;
    \item PR: \pullrequest{\fluxml}{\flux}{372} reviewed by \mikeinnes;
